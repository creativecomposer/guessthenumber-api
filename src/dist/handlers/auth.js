...
var realPassword = "$2b$10$9uBPY6wh5AK25Lz1CQXtaeX8SUxIcP5M5g7mHLMSf8fuxgOWdYLjC";
var loginUser = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var isValid, token, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, auth_1.comparePasswords)(req.body.password, realPassword)];
                case 1:
                    isValid = _a.sent();
                    if (!isValid) {
                        res.status(401).json({ error: "Incorrect credentials" });
                    ...
                    token = (0, auth_1.createJWT)(req.body.username);
                    user = {
                        name: "Nelson Mandela",
